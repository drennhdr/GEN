...
export class DashboardComponent implements OnInit {
  ...
  userType: number = Number(sessionStorage.getItem('userType'));
  // dashCustomer: boolean = false;
  // dashAdmin: boolean = false;
  // dashAccessioning: boolean = false;
  // dashCET: boolean = false;
  // dashLCS: boolean = false;
  ...
  ngOnInit() {
    ...
    //     break;
    //   }
    //   case 6:   //	Corp. Accessioning
    //   {
    //     this.dashAccessioning = true;
    //     break;
    //   }
    //   case 7:   //	CET
    //   {
