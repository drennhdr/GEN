  ...
  generateGPP(labOrder: LabOrderModel, gppData: GPPModel, patientData: PatientModel, PhysicianSig: string, PatientSig: string) {
    ...
    doc.addImage(img, 'JPEG', 0, 0, 612, 792);
        ...
        if (labOrder.patientSignatureId == -1)
        {
            ...
            doc.text(formatDate(labOrder.specimens[0].collectionDate, 'MM/dd/yyyy', 'en'),480, 407);
        }
        ...
        if (labOrder.datePatientSignature != null){
            doc.text(formatDate(labOrder.datePatientSignature, 'MM/dd/yyyy', 'en'),480, 407);
        }
        ...
        doc.text(formatDate(labOrder.specimens[0].collectionDate, 'MM/dd/yyyy', 'en'), 280, 530);
        ...
        if (labOrder.userSignatureId_Physician == -1)
        {
            ...
            doc.text(formatDate(labOrder.specimens[0].collectionDate, 'MM/dd/yyyy', 'en'),510, 720);
        }
        ...
        if (labOrder.datePhysicianSignature != null){
            ...
            doc.text(formatDate(labOrder.datePhysicianSignature, 'MM/dd/yyyy', 'en'),510, 720);
        }
