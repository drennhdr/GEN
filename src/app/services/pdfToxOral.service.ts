...
export class PdfToxOralService {
  ...
  // ------------------------------------------------------------------------------------------------------------------
  generateToxOral(labOrder: LabOrderModel, toxData: ToxOralModel, patientData: PatientModel, physicianNPI: string, PhysicianSig: string, PatientSig: string) {
    ...
    if (labOrder.patientSignatureId == -1)
    {
        ...
        doc.text(formatDate((labOrder.specimens[0].collectionDate + 'Z').toLocaleString(), 'MM/dd/yyyy', 'en'),480, 434);
    }
    ...
    if (labOrder.datePatientSignature != null){
        doc.text(formatDate((labOrder.datePatientSignature + 'Z').toLocaleString(), 'MM/dd/yyyy', 'en'),480, 434);
    }
    ...
    doc.text(formatDate((labOrder.specimens[0].collectionDate + 'Z').toLocaleString(), 'MM/dd/yyyy', 'en'), 290, 522);
    ...
    if (labOrder.userSignatureId_Physician == -1)
    {
        ...
        doc.text(formatDate((labOrder.specimens[0].collectionDate + 'Z').toLocaleString(), 'MM/dd/yyyy', 'en'),470, 773);
    }
    ...
    if (labOrder.datePhysicianSignature != null){
        ...
        doc.text(formatDate((labOrder.datePhysicianSignature + 'Z').toLocaleString(), 'MM/dd/yyyy', 'en'),470, 773);
    }
